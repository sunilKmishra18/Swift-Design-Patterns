...
class PersonTableViewCell: UITableViewCell {
    ...
    private var viewModel:PersonTableCellViewModel?
    ...
    @objc private func didTapButton(){
        ...
        delegate?.PersonTableViewCell(cell: self, didTapWith: newViewModel)
    ...
    func configure(with viewModel: PersonTableCellViewModel){
    ...
    override func layoutSubviews() {
        ...
        button.frame=CGRect(x: contentView.frame.size.width-120, y: 1, width: 110, height: contentView.frame.size.height-20)
    }
